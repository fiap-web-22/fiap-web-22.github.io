...
const mudaFrase = (alvo, texto, tempo) => {
  ...
  setInterval(() => {
    document.querySelector(alvo).innerHTML = texto[total >= texto.length -1 ? total = 0 : total+=1]; //total é maior ou igual que frases -1? não, no começo é 0 então total +1 e vai incrementando e mudando a frase até chegar a 1, aí ele vira zero e começa de novo // outra forma é iniciar a variável como 2 ou -1 e começar com a primeira frase
  }, tempo * 1000);
